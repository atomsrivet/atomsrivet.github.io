...
function populateGrid(){
    ...
    if (flag_restart === false) {
      ...
      layout = Math.floor(Math.random() *27) + 1;
      rooms = readFile('layout/r' + layout.toString() + '.txt');
      }
    else {
      flag_restart = false
    }
  ...
  if ((rooms[i][j])==='-'){
       ...
       for (m=1; m<ms; m++){
       	if (rooms[i][j]===('d' + m)){
       		if (flag_transfer===false){
            if (parameters.img_tool=='c') {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/s' + s_order[m-1] + parameters.img_door, board.characterimg[i][j].rect);
            } else {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/' + parameters.img_door + c_order[m-1] + '.png', board.characterimg[i][j].rect);
            }
          } else {
            if (parameters.img_tool=='s') {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/s' + s_order[m-1] + parameters.img_door_t, board.characterimg[i][j].rect);
            } else {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/' + parameters.img_door_t + c_order[m-1] + '.png', board.characterimg[i][j].rect);
            }
          }
          board.obj[i][j].object.attr({"opacity":1});
          board.grid[i][j].isfull = true;
       ...
       for (m=1; m<ms; m++){
       	if (rooms[i][j]===('k' + m)){
       		if (flag_transfer===false){
            if (parameters.img_tool=='c') {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/s' + s_order[m-1] + parameters.img_key, board.characterimg[i][j].rect);
            } else {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/' + parameters.img_key + c_order[m-1] + '.png', board.characterimg[i][j].rect);
            }
          } else {
            if (parameters.img_tool=='s') {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/s' + s_order[m-1] + parameters.img_key_t, board.characterimg[i][j].rect);
            } else {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/' + parameters.img_key_t + c_order[m-1] + '.png', board.characterimg[i][j].rect);
            }
          }
          board.obj[i][j].object.attr({"opacity":1});
          board.grid[i][j].isfull = true;
       ...
       for (m=1; m<ms; m++){
       	if (rooms[i][j]===('c' + m)){
       		if (flag_transfer===false){
            if (parameters.img_tool=='c') {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/s' + s_order[m-1] + parameters.img_catapult, board.characterimg[i][j].rect);
            } else {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/' + parameters.img_catapult + c_order[m-1] + '.png', board.characterimg[i][j].rect);
            }
          } else {
            if (parameters.img_tool=='s') {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/s' + s_order[m-1] + parameters.img_catapult_t, board.characterimg[i][j].rect);
            } else {
              board.obj[i][j].object  = drawImage(board.paper.object, 'img/shapes/' + parameters.img_catapult_t + c_order[m-1] + '.png', board.characterimg[i][j].rect);
            }
          }
          board.obj[i][j].object.attr({"opacity":1});
          board.grid[i][j].isfull = true;
